...
const SProducts = () => {
    ...
    return ( 
        <div className="featured w-fit">
              <nav className='flex justify-between w-screen py-[36px] px-[24px]'>
                <div className=" flex flex-col gap-[16px] h-[50px] ">
                    <h1 className="font-poppins font-normal md:font-bold text-[16px] md:text-[24px] text-[#272727] tracking-[15%] leading-[34.2px]">Similar Products</h1>
                    <p className=' hidden md:block w-[150px] border-t-[4px] border-[#FF0017]'></p>
                </div>
                <div className='flex gap-[15px] items-center'>
                <section className="flex gap-[4px] h-[25px] w-[127px]">
                    <button onClick={prePage} className='h-[24px] w-[24px]'><img src="./src/assets/left.png" alt="img" /></button>
                   <div className="flex h-[25px] w-[71px] bg-[#DADADA]">
                    ...
                    <button onClick={nextPage} className='h-[24px] w-[24px]'><img src="./src/assets/right.png" alt="img" /></button>
                   
                </section>
                <img className="h-[16px] w-[92px]" src="./src/assets/more.png" alt="img" />
                </div>
            </nav>
            <section className="grid grid-cols-1 md:grid-cols-2 gap-[24px] h-[956px] md:h-[682px] max-w-screen py-[32px] px-[10px] sm:px-[48px]">
            {newProducts.map((p)=>(
